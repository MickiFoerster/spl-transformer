cat << EOM
#!/usr/bin/env zsh
#BSUB -J plain-parallel-hessian-fof-p$1
#BSUB -o job%J-plain-parallel-hessian-fof.stdout
#BSUB -e job%J-plain-parallel-hessian-fof.stderr
...
cd \$BASE
jobdir=/hpcwork/mf510951/plain-parallel-hessian-job-with-$1-threads-fof-id\$RANDOM; 
