cat << EOM
#!/usr/bin/env zsh
#BSUB -J plain-parallel-hessian-for-p$1
#BSUB -o job%J-plain-parallel-hessian-for.stdout
#BSUB -e job%J-plain-parallel-hessian-for.stderr
...
cd \$BASE
jobdir=/hpcwork/mf510951/plain-parallel-hessian-job-with-$1-threads-for-id\$RANDOM; 
