...
int main(int argc, char* argv[])
{
	...
	DEFINE_ARR( a2_a1_thread_result, omp_get_num_procs() );
	...
	DEFINE_ARR(a2_x, n);
	DEFINE_ARR(a1_x, n);
	DEFINE_ARR(a2_a1_x, n);

	DEFINE_MTX(A, n);
	DEFINE_MTX(a2_A, n);
	DEFINE_MTX(a1_A, n);
	DEFINE_MTX(a2_a1_A, n);
	...
	cerr << "reverse over reverse test\n";
	#include "a2_a1_test.in.spl.spl"
