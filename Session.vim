...
map <C-F10> :bufdo e
map <S-F8> ?\(\\begin\|\\end\|\\bib\)
map <F8> /\(\\begin\|\\end\|\\bib\)
map <S-F7> ?\(\\part[^a-z]\|\\chapter\|\\section\|\\subsection\|\\subsubsection\|\\paragraph\)
map <F7> /\(\\part[^a-z]\|\\chapter\|\\section\|\\subsection\|\\subsubsection\|\\paragraph\)
map <S-F6>  :w !detex|wc -w
map <F6> :!ctags *.cpp *.h *.c *.cc *.hpp *.tex
map <S-F5> :VCSDiff
map <F5> :TlistToggle
...
iabbr texsrctrans \begin{table}[!ht]\begin{center}\begin{tabular}{ccc}\begin{lstlisting}S/*@$_0$@*/ #pragma omp parallel{S/*@$_1$@*/ }S/*@$_2$@*/ \end{lstlisting}&\rule[0mm]{10mm}{0mm}$\longmapsto$\rule[0mm]{10mm}{0mm}&\begin{lstlisting}/*@$\sigma_{(1)}($@*/S/*@$_0)$@*/ #include "store_checkpoint.inc"#pragma omp parallel{S/*@$_1$@*/ }/*@$\sigma_{(1)}($@*/S/*@$_2)$@*/ /*@$\tau($@*/S/*@$_2)$@*/ #include "restore_checkpoint.inc"#pragma omp parallel{/*@$\sigma_{(1)}($@*/S/*@$_1)$@*/ while( /*@$\NOT\ \STACKEMPTY$@*/ ) { /*@$\tau($@*/S/*@$_1)$@*/ }}/*@$\sigma_{(1)}($@*/S/*@$_0)$@*/ \end{lstlisting}\\\rule[10mm]{0mm}{0mm} Original program $P$ with three    &  &  The adjoint model of $P$ by using the  \\sequences of statements.           &  &  joint reversal scheme \cite[p.~80]{naumann2012art}.  \\\end{tabular}\end{center}\end{table}
...
set tabpagemax=20
set tabstop=4
set titlestring=%t%(\ %M%)%(\ (%{expand(\"%:~:.:h\")})%)%(\ %a%)%=phi
set updatetime=500
...
silent only
cd ~/comgit/phd/code/compiler/spl-transformer
...
badd +1 scanner.lpp
badd +290 parser.ypp
badd +1466 ast_vertex.cpp
badd +431 unparser.cpp
badd +1 main.cpp
badd +333 ast_vertex.h
badd +36 unparser.h
badd +65 unparser_original.cpp
badd +1 CMakeLists.txt
badd +26 AST.h
badd +1 AST.cpp
badd +62 symbol_table.h
badd +179 Session.vim
badd +222 sigma.cpp
badd +129 ~/.vimrc
badd +270 tau.cpp
badd +235 rho.cpp
badd +81 symbol_table.cpp
badd +4 /tmp/asdf
badd +1 parser.output
badd +1 exclusive_read_analysis.cpp
badd +119 prg-analysis/constant-propagation/constant-propagation.cpp
badd +16 prg-analysis/constant-propagation/constant-propagation.h
badd +1 prg-analysis/interval-analysis/interval-analysis.cpp
badd +1 prg-analysis/interval-analysis/interval-analysis.h
badd +256 prg-analysis/exclusive-read/exclusive-read.cpp
badd +19 prg-analysis/exclusive-read/exclusive-read.h
args scanner.lpp parser.ypp ast_vertex.cpp unparser.cpp main.cpp
edit scanner.lpp
...
silent! normal! zE
let s:l = 124 - ((25 * winheight(0) + 23) / 46)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 87 - ((18 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
87
normal! 04|
tabedit ast_vertex.h
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd t
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 40 + 24) / 49)
exe 'vert 1resize ' . ((&columns * 81 + 84) / 168)
exe '2resize ' . ((&lines * 40 + 24) / 49)
exe 'vert 2resize ' . ((&columns * 86 + 84) / 168)
argglobal
3argu
edit ast_vertex.h
setlocal keymap=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 333 - ((31 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
333
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1466 - ((6 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1466
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 15 - ((6 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
15
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 81 - ((30 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
81
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 36 - ((11 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
36
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 244 - ((17 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
244
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 235 - ((18 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
235
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 220 - ((25 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
220
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 36 - ((16 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
36
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 431 - ((12 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
431
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 79 - ((13 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
79
normal! 031|
tabedit prg-analysis/exclusive-read/exclusive-read.h
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 1 + 84) / 168)
exe 'vert 2resize ' . ((&columns * 166 + 84) / 168)
argglobal
edit prg-analysis/exclusive-read/exclusive-read.h
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal nobinary
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 31 - ((22 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
...
wincmd w
argglobal
edit prg-analysis/exclusive-read/exclusive-read.cpp
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal nobinary
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1869 - ((22 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1869
